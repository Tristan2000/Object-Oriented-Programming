  ...
  public void findRanking(){
    ...
    if(gender.equals("Male")){
      if (mapForBoy[year - 2001].containsKey(name)){
        lblResult.setText("The name: " + name + " is ranked: " + mapForBoy[year - 2001].get(name) + "in the year: " + year);
      }
      else{
      ...
      if (mapForGirl[year - 2001].containsKey(name)){
        lblResult.setText("The name: " + name + " is ranked: " + mapForGirl[year - 2001].get(name) + "in the year: " + year);
      }
      else{
        lblResult.setText("That name is not ranked");
      }
