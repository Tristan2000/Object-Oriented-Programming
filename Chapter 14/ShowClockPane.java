...
public class ShowClockPane extends Application{
  public void start(Stage primaryStage){
    ...
    primaryStage.setTitle("ClockPane"); // Set the stage title
 ...
 class ClockPane extends Pane {
  ...
  int minuteRandom = (int)(Math.random() * 2);
  int hourRandom = (int)(Math.random() * 12);
  ...
  public void setCurrentTime() {
    ...
    this.hour = hourRandom;
    this.minute = minuteRandom;
